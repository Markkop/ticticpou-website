            ...
            <div className="border-t border-border bg-muted/20 p-3 sm:p-4">
              ...
              {match.participants && match.participants.length > 0 ? (
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="font-medium text-sm flex items-center gap-1">
                                <span className="truncate">{participant.displayName || 'Usuário desconhecido'}</span>
                                {participant.isWinner && <Trophy className="w-3 h-3 text-yellow-500 flex-shrink-0" />}
                              </div>
                              <div className="text-xs text-muted-foreground truncate">{participant.className}</div>
                            </div>
                          </div>
                          
                          <div className="flex items-center justify-between text-xs bg-background/30 rounded px-2 py-1">
                            <div className="text-center">
                              <div className="text-muted-foreground">Elim.</div>
                ...
                <div className="text-center py-6 text-muted-foreground">
                  ...
                  <p className="text-sm">Dados dos participantes não disponíveis</p>
                  <p className="text-xs">Esta funcionalidade será implementada em breve</p>
                </div>
              )}
            </div>
          </CollapsibleContent>
